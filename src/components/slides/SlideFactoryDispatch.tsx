    ...
    <div className="slide-inner">
      <div className="w-full" style={{ fontFamily: '"JetBrains Mono", monospace' }}>
        ...
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center gap-2.5 text-[20px] tracking-[3px] uppercase" style={{ fontFamily: '"DM Serif Display", serif', color: '#c4cad4' }}>
            <div className="w-7 h-7 flex items-center justify-center" style={{ border: '2px solid #8b9dc3' }}>
              <div className="w-3 h-3" style={{ border: '2px solid #f97316', animation: 'statusPulse 2s infinite' }} />
            </div>
            {title}
          </div>
        ...
        <div className="grid grid-cols-[1fr_260px] gap-6">
          ...
          <div className="rounded-lg overflow-hidden" style={{ background: '#1a1d21', border: '1px solid rgba(139,157,195,0.15)' }}>
            <div className="flex justify-between items-center px-4 py-3" style={{ background: 'rgba(0,0,0,0.3)', borderBottom: '1px solid rgba(139,157,195,0.1)' }}>
              <span className="text-[10px] uppercase tracking-[2px]" style={{ color: '#8b9dc3' }}>
            ...
            <div className="relative" style={{ height: '300px', overflow: 'hidden' }}>
              ...
              <div className="absolute top-[30px] left-1/2 -translate-x-1/2 z-10">
                <div className="w-20 h-10 rounded flex items-center justify-center" style={{ background: 'linear-gradient(180deg, #3d4450, #2d3339)', border: '2px solid #4a5568' }}>
                  <div className="w-[22px] h-[22px] rounded-full" style={{ background: 'radial-gradient(circle, #3b82f6 0%, #1e40af 100%)', border: '2px solid #4b5563', animation: 'scanGlow 2s infinite' }} />
                </div>
                <div className="w-3.5 h-5 mx-auto" style={{ background: '#3d4450', borderLeft: '2px solid #4a5568', borderRight: '2px solid #4a5568' }} />
              </div>

              {/* Beam */}
              <div className="absolute top-[60px] left-1/2 -translate-x-1/2 w-0.5 opacity-70" style={{ height: '120px', background: 'linear-gradient(180deg, #3b82f6, transparent)' }} />
              ...
              <div className="absolute bottom-[78px] left-0 right-0">
                {[
                  ...
                  <div key={i} className="absolute bottom-0" style={{ animation: `itemMove 9s linear infinite`, animationDelay: item.delay }}>
                    {/* Label */}
                    <span
                      className="absolute -top-7 left-1/2 -translate-x-1/2 text-[8px] font-semibold px-2 py-0.5 rounded-sm whitespace-nowrap text-white"
                      style={{
                    ...
                    <div
                      className="rounded"
                      style={{
                        width: item.shape === 'drum' ? '35px' : '50px',
                        height: item.shape === 'drum' ? '50px' : '42px',
                        background:
              ...
              {/* Conveyor */}
              <div
                className="absolute bottom-[50px] left-[30px] right-[30px] h-7 rounded-sm"
                style={{
              ...
              />
              <div className="absolute bottom-[46px] left-[30px] right-[30px] h-9 rounded-b-md" style={{ border: '2px solid #3d4450', borderTop: 'none' }} />
            </div>
          </div>

          {/* Side panel */}
          <div className="flex flex-col gap-5">
            <div className="rounded-lg p-4" style={{ background: '#1a1d21', border: '1px solid rgba(139,157,195,0.15)' }}>
              <div className="text-[9px] uppercase tracking-[1.5px] pb-2.5 mb-3" style={{ color: '#f97316', borderBottom: '1px solid rgba(139,157,195,0.1)' }}>
              ...
              {[
                ...
                <div key={i} className="flex justify-between mb-3 text-[11px]">
        ...
        {/* Use cases */}
        <div className="mt-5">
          <div className="text-[9px] uppercase tracking-[2px] mb-3" style={{ color: '#8b9dc3' }}>Operations</div>
          <div className="grid grid-cols-5 gap-3">
            {[
              ...
              <div key={i} className="rounded-md p-4 transition-all duration-200 hover:-translate-y-0.5" style={{ background: '#1a1d21', border: '1px solid rgba(139,157,195,0.12)' }}>
                <div className="text-xl mb-2.5">{uc.icon}</div>
                <div className="text-[14px] tracking-wide mb-1.5 text-white" style={{ fontFamily: '"DM Serif Display", serif' }}>{uc.name}</div>
                <div className="text-[9px]" style={{ color: '#22c55e' }}>{uc.metric}</div>
              </div>
            ))}
          </div>
        </div>
